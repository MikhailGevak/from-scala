...
^{:refer t6.from-scala.core/$ :added "0.1.0"}
(fact
...
^{:refer t6.from-scala.core/var-args :added "0.1.0"}
(fact
...
^{:refer t6.from-scala.core/function :added "0.1.0"}
(fact
...
^{:refer t6.from-scala.core/partial :added "0.1.0"}
(fact
...
^{:refer t6.from-scala.core/view :added "0.1.0"}
(fact
...
^{:refer t6.from-scala.core/decode-scala-symbol :added "0.1.0"}
(fact
...
^{:refer t6.from-scala.core/encode-scala-symbol :added "0.1.0"}
(fact
